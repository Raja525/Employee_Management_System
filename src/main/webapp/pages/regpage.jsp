                        ...
                        <table class="table">
                            ...
                            %>
                            	<tr>
                            		...
                            		<td><form action="ideditreg" method="post"><button class="btn btn-warning" type="submit" name="edit" value="<%=reglist.get(i).getDeptId()%>">Edit</button></form></td>
                            		<td><form action="iddeletereg" method="post"><button class="btn btn-danger" type="submit" name="delete" value="<%=reglist.get(i).getDeptId()%>">Delete</button></form></td>                            		                  
                            	</tr>
                            	<%
                            	}
                            	%>
