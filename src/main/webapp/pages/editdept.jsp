...
<body>
	<div id="box" class="row">
        ...
        <div class="col-md-10" id="contentpage">
            <div id="formbox">
            <%
            		List<Department> deptlist=(List<Department>)request.getAttribute("editdeptlist");
           // System.out.println(emplist);
            	for(int i=0;i<deptlist.size();i++){
            %>
                <form action="deptupdate" method="POST">
                	<input class="form-control" type="text" name="deptId" placeholder="Employee Name" value="<%=deptlist.get(i).getDeptId()%>">
                    <input class="form-control" type="text" name="deptName" placeholder="Employee Name" value="<%=deptlist.get(i).getDeptName()%>">
