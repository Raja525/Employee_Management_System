                        ...
                        <table class="table">
                            ...
                            %>
                            	<tr>
                            		...
                            		<td><form action="ideditdept" method="post"><button class="btn btn-warning" type="submit" name="edit" value="<%=deptlist.get(i).getDeptId()%>">Edit</button></form></td>
                            		<td><form action="iddeletedept" method="post"><button class="btn btn-danger" type="submit" name="delete" value="<%=deptlist.get(i).getDeptId()%>">Delete</button></form></td>                            		                  
                            	</tr>
                            	<%
                            	}
                            	%>
