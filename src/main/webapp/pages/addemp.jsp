        ...
        <div class="col-md-10" id="contentpage">
            <div id="formbox">
                <form action="addemp" method="POST">
                    <input class="form-control" type="text" name="empname" placeholder="Employee Name">
                    <input class="form-control" type="text" name="empno" placeholder="Mobile Number">
                    <input class="form-control" type="text" name="empdept" placeholder="Employee Department">
